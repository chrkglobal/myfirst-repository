...
export default class extends React.Component {
   render() {
      return  (
        <div className="row border-bottom" id="content">
        <nav className="navbar navbar-static-top" role="navigation" style={{marginBottom: 0}}>
          <div className="navbar-header">
             
            {/* <button className="navbar-minimalize minimalize-styl-2 btn btn-primary"><i className="fa fa-bars" /> </button> */}
            <a className="navbar-minimalize minimalize-styl-2 btn btn-primary" id="sidebarCollapse">
